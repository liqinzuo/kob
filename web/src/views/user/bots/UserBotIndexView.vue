                        ...
                        <div class="modal fade" id="add-bot-btn" tabindex="-1">
                            <div class="modal-dialog modal-xl">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" @click="add_bot(bot)">创建</button>
...
export default{
    ...
    setup(){
        ...
        const refresh_bots = () => {
            $.ajax({
                url: "http://localhost:3600/user/bot/getlist/",
                type: "get",
                headers:{
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url: "http://localhost:3600/user/bot/add/",
                type: "post",
                data:{
                    title: botadd.title,
        ...
        const update_bot = (bot) => {
            bot.error_message = " ";
            $.ajax({
                url: "http://localhost:3600/user/bot/update/",
                type: "post",
                data:{
                    bot_id: bot.id,
                    title: bot.title,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "http://localhost:3600/user/bot/remove/",
                type: "post",
                data:{
                    bot_id: bot.id,
                },
